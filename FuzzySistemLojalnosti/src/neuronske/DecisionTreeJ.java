...
public class DecisionTreeJ {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Grescica");
			e.printStackTrace();
		}
	}
	/** file names are defined */
	public static final String TRAINING_DATA_SET_FILENAME = "treningL.txt";
	public static final String TESTING_DATA_SET_FILENAME = "testL.txt";
